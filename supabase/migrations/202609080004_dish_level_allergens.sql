-- Permite declarar alérgenos para el plato completo en el formato Excel sencillo.
-- No modifica ni elimina cartas existentes; las cartas sin estos campos conservan
-- la validación por ingrediente.
BEGIN;
